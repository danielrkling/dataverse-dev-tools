...
import { makeGitFs, statusLabel } from "../services/git-fs.mjs";
  ...
  executeEffect: (parsed, term) => {
    ...
    return /** @type {Effect.Effect<string | undefined, Error>} */ (
      Effect.gen(function* () {
        ...
        // GitStatusLive is provided locally (not via commandLayers) to keep
        // the layer wiring explicit for this command.
